...
exports.UPLOAD_CONFIG = {
    ...
    AUDIO: {
        ...
        SIZE: {
            MIN: 1024, // 1KB
            DEFAULT: config_1.default.fileUpload.maxSize, // From environment config
        ...
        ERRORS: {
            ...
            SIZE: `Audio file size must be between 1KB and ${config_1.default.fileUpload.maxSize / (1024 * 1024)}MB`
        }
    },
    ...
    IMAGE: {
        ...
        ERRORS: {
            ...
            SIZE: `Image file size must be between 1KB and ${config_1.default.fileUpload.maxSize / (1024 * 1024)}MB`
        }
    },
    ...
    DOCUMENT: {
        ...
        ERRORS: {
            ...
            SIZE: `Document file size must be between 1KB and ${config_1.default.fileUpload.maxSize / (1024 * 1024)}MB`
        }
    },
    // General upload configuration
    GENERAL: {
        // Maximum number of files per upload
        MAX_FILES: config_1.default.fileUpload.maxFiles, // From environment config
        ...
        ERRORS: {
            ...
            TOO_MANY_FILES: `Too many files uploaded. Maximum allowed is ${config_1.default.fileUpload.maxFiles} files`
        }
    }
};
// Log upload configuration
console.log(`Upload config loaded for environment: ${config_1.default.env}`);
console.log(`Max file size: ${config_1.default.fileUpload.maxSize / (1024 * 1024)}MB`);
console.log(`Max files: ${config_1.default.fileUpload.maxFiles}`);
exports.default = exports.UPLOAD_CONFIG;
