...
const sendCourseInquiryMail = async (name, email, mobile, courseName, attachmentPath = null) => {
  ...
  const html = `
    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 20px; max-width: 650px; margin: 0 auto; background-color: #f8fafc;">
      <div style="background-color: white; padding: 40px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); border-top: 4px solid #2563eb;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 35px; padding-bottom: 25px; border-bottom: 2px solid #e5e7eb;">
          <tr>
            <td style="text-align: center; vertical-align: middle;">
              <div style="background: linear-gradient(135deg, #2563eb 0%, #f4b31bff 100%); color: white; padding: 15px 25px; border-radius: 8px; display: inline-block; margin-bottom: 15px;">
                <h1 style="margin: 0; font-size: 24px; font-weight: 600;">🎓 New Course Inquiry</h1>
              </div>
        ...
        <div style="margin-bottom: 30px;">
          <h2 style="color: #1f2937; margin-bottom: 20px; font-size: 20px; font-weight: 600; display: flex; align-items: center;">
            <span style="background-color: #dbeafe; color: #2563eb; padding: 8px; border-radius: 50%; margin-right: 12px; font-size: 16px;">👤</span>
            Student Information
          </h2>
          
          <div style="background-color: #f9fafb; padding: 25px; border-radius: 10px; border-left: 4px solid #2563eb;">
            <div style="display: grid; gap: 18px;">
              
              <div style="display: flex; align-items: center; padding: 12px 0; border-bottom: 1px solid #e5e7eb;">
                <div style="background-color: #dbeafe; color: #2563eb; padding: 8px; border-radius: 6px; margin-right: 15px; font-size: 14px; min-width: 35px; text-align: center;">
                  👨‍🎓
                </div>
                <div>
                  <strong style="color: #374151; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px;">Full Name</strong>
                  <div style="color: #1f2937; font-size: 16px; font-weight: 500; margin-top: 4px;">${name}</div>
                </div>
              </div>
              
              <div style="display: flex; align-items: center; padding: 12px 0; border-bottom: 1px solid #e5e7eb;">
                <div style="background-color: #dcfce7; color: #16a34a; padding: 8px; border-radius: 6px; margin-right: 15px; font-size: 14px; min-width: 35px; text-align: center;">
                  📧
                </div>
                <div>
              ...
              <div style="display: flex; align-items: center; padding: 12px 0;">
                <div style="background-color: #fef3c7; color: #d97706; padding: 8px; border-radius: 6px; margin-right: 15px; font-size: 14px; min-width: 35px; text-align: center;">
                  📱
                </div>
                <div>
                  <strong style="color: #374151; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px;">Mobile Number</strong>
                  <div style="color: #1f2937; font-size: 16px; font-weight: 500; margin-top: 4px;">
        ...
        <div style="margin-bottom: 30px;">
          <h2 style="color: #1f2937; margin-bottom: 20px; font-size: 20px; font-weight: 600; display: flex; align-items: center;">
            <span style="background-color: #fef3c7; color: #d97706; padding: 8px; border-radius: 50%; margin-right: 12px; font-size: 16px;">📚</span>
            Course Interest
          </h2>
          
          <div style="background-color: #fffbeb; padding: 25px; border-radius: 10px; border-left: 4px solid #d97706;">
            <div style="text-align: center;">
              <div style="background: linear-gradient(135deg, #d97706 0%, #fc0d1dff 100%); color: white; padding: 15px 25px; border-radius: 8px; display: inline-block;">
        ...
        <div style="background-color: #eff6ff; border-left: 4px solid #2563eb; padding: 20px; margin: 30px 0; border-radius: 8px;">
          <div style="display: flex; align-items: flex-start;">
            <div style="background-color: #2563eb; color: white; padding: 8px; border-radius: 50%; margin-right: 15px; font-size: 16px; min-width: 35px; text-align: center;">
              ⚡
            </div>
            <div>
              <h3 style="margin: 0 0 10px 0; color: #1e40af; font-size: 16px; font-weight: 600;">Action Required</h3>
              <ul style="margin: 0; color: #1e40af; line-height: 1.6; padding-left: 20px;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <div style="display: inline-flex; gap: 15px; flex-wrap: wrap; justify-content: center;">
            <a href="mailto:${email}" style="background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 500; display: inline-flex; align-items: center; gap: 8px;">
              📧 Reply via Email
            </a>
            <a href="tel:${mobile}" style="background-color: #16a34a; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 500; display: inline-flex; align-items: center; gap: 8px;">
              📞 Call Student
            </a>
          </div>
        </div>
